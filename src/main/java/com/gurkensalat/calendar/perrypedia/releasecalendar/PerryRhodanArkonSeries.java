...
{
    // PRAR 1 - 22.1.2016 - one day less to put it on thursday
    private static final DateTime RELEASE_OF_ISSUE_1 = new DateTime().withDate(2016, 1, 22).minusDays(1).withMillisOfDay(0);
